...
const MOBILE = ['real-pay-detail-m', 'real-pay-done-m', 'real-pay-cash-m', 'real-client-new-m', 'real-client-detail-m', 'real-client-overdrawn-m'];
const DESKTOP = ['real-client-new', 'real-clients-split', 'real-clients-overdrawn', 'before-dp-split'];
