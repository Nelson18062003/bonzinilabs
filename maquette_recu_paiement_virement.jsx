  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0edf3", padding: "24px 16px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 900, color: B.violetDark, marginTop: 4 }}>Reçu de paiement — Virement bancaire</div>
      </div>

      <ReceiptLayout type="paiement" reference="BZ-PY-2026-0018">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          <StatusBadge status="Effectué" color={B.violet} bg={B.violetLight} />
          <span style={{ fontSize: 11, color: B.muted }}>05 mars 2026 à 14:20</span>
        </div>

        <AmountBlock amount={5000000} details={[
          { label: "Montant envoyé", value: "¥57 471" },
          { label: "Taux appliqué", value: "11 494" + " XAF/M" },
        ]} />

        <SectionTitle>Transaction</SectionTitle>
        <InfoRow label="Mode de paiement" value="Virement bancaire" color={B.violet} bold />
        <InfoRow label="Date de création" value="05 mars 2026 à 13:50" />
        <InfoRow label="Date de traitement" value="05 mars 2026 à 14:20" />

        <SectionTitle>Client</SectionTitle>
        <InfoRow label="Nom" value="Kamga Paul" bold />
        <InfoRow label="Téléphone" value="+237 677 889 900" />

        <SectionTitle>Bénéficiaire (Compte bancaire)</SectionTitle>
        <InfoRow label="Titulaire" value="Wang Corporation Ltd" bold />
        <InfoRow label="Banque" value="Bank of China" />
        <InfoRow label="N° de compte" value="6214 •••• •••• 8820" />
        <InfoRow label="Agence" value="Guangzhou Branch" />
        ...
        <div style={{ padding: 16, background: B.light, borderRadius: 12, border: "1px solid " + B.border }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 700, color: B.muted }}>Confirmation de virement</span>
            <span style={{ fontSize: 10, color: B.muted }}>05 mars 2026 à 14:20</span>
          </div>
          <div style={{
            width: "100%", height: 160, background: "#e8e4ed",
            borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center",
            border: "1px solid " + B.border,
          }}>
            <div style={{ textAlign: "center", color: "#aaa", fontSize: 11 }}>[ Justificatif bancaire ]</div>
          </div>
        </div>
      </ReceiptLayout>
    </div>
