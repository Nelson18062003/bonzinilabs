...
export const BONZINI_PLAYBOOK: string = [
  ...
  `OUTIL DÉDIÉ : pour « quoi de neuf ? », « qu'est-ce qui demande mon attention ? », « fais le point », utilise get_pending_summary — il remonte en UN appel les dépôts en attente trop vieux, les paiements en souffrance, les soldes dormants et les taux personnalisés récents (avec noms, montants et ancienneté). Ne devine pas le SQL : ce radar existe pour ça. Présente d'abord le plus urgent.`,
