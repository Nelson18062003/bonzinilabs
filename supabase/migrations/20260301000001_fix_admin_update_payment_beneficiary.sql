-- ============================================================
-- Fix: admin_update_payment_beneficiary — correct is_admin call
-- The previous migration called is_admin() without its required
-- _user_id UUID parameter. Correct call: public.is_admin(v_caller_id)
-- ============================================================
