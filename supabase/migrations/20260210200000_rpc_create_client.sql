-- RPC function to create a client user directly from the database
...
BEGIN
  ...
  -- 11. handle_new_user trigger fires and creates profile + wallet
  -- Update profile with phone number (trigger may or may not set it)
