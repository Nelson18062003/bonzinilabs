-- ============================================================
-- admin_correct_payment — retrait du plafond de 50 000 000 XAF.
--
-- Décision produit du 14/09/2026 : aucun plafond sur les montants, ni dans
-- les formulaires ni côté serveur. Cette RPC était la dernière à refuser un
-- montant XAF au-delà de 50 M. Redéfinition COMPLÈTE (pas de patch en
-- place) : le corps est celui de 20260821130000_admin_correct_payment.sql,
-- seul le garde-fou change (entier > 0, sans borne haute). Tout le reste —
-- super admin uniquement, FOR UPDATE sur le paiement et le portefeuille,
-- écritures compensatoires, timeline, audit — est inchangé.
-- ============================================================
