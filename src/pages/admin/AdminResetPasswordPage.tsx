...
export function AdminResetPasswordPage() {
  ...
  const canonicalUrl = useMemo(() => `${window.location.origin}/admin/reset-password`, []);

  useEffect(() => {
    document.title = "Réinitialiser mot de passe admin | Bonzini";
    setMeta("description", "Réinitialiser le mot de passe administrateur Bonzini pour accéder au back-office.");
      ...
      <div className="w-full max-w-md">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {hasSession
                ? "Choisissez un nouveau mot de passe pour accéder à l'administration."
