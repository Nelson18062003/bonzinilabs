...
import { BASE_2409, COUNTRIES_2409, DATE_2409, FlyerEssential, FlyerTable, TIERS_2409 } from './rateFlyerV2';
...
const Flyer = p.get('variant') === 'table' ? FlyerTable : FlyerEssential;
