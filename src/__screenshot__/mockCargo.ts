...
export const useCargoClient = (id: string | null) => ok(id === 'u5' ? { id: 'u5', first_name: 'Fatou', last_name: 'Ndiaye', company_name: 'Ndiaye & Fils', phone: '+237 690 55 66 77', email: 'fatou@ndiaye-fils.cm', city: 'Douala', country: 'Cameroun', kyc_verified: true } : null);
