...
export const MOBILE_MONEY_GUIDE_COPY = {
  ...
  cover: {
    ...
    preuve: { fr: 'Puis la preuve', en: 'Then the proof' },
  ...
  flotte: {
    ...
    needs: { fr: 'Numéro + Titulaire', en: 'Number + Holder' },
  ...
  retrait: {
    ...
    legend: { fr: 'La somme, en chiffres, sans espace.', en: 'The amount, in figures, no spaces.' },
  },
  preuve: {
