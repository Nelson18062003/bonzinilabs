      ...
      <div className={cn(desktop ? 'space-y-5' : 'flex-1 space-y-5 px-4 py-5', !desktop && SURFACE.canvas)}>
        <Card>
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#F5F5F5] text-[#1E1E1E] dark:bg-[#383838] dark:text-[#F5F5F5]">
        ...
        <div>
          ...
          <Card>
            {isLoading ? (
              ...
              <p className={cn('py-3 text-[14px]', TEXT.muted)}>
                ...
                {passkeys.map((passkey) => (
                  <li key={passkey.id} className="flex items-center gap-3 py-3">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-full p-2 text-[#900B09] transition hover:bg-[#FDD3D0] disabled:opacity-50 dark:text-[#FDD3D0] dark:hover:bg-[#900B09]"
                    >
        ...
        {supported === false ? (
          <p className={cn('px-1 text-[14px]', TEXT.muted)}>
