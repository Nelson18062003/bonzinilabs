...
import { SURFACE, TEXT, StatusPill, Avatar, Holder } from '@/mobile/designKit';
  ...
  const header = (
    ...
    >
      ...
      <button
        ...
        className={cn('flex h-9 w-9 shrink-0 items-center justify-center rounded-full active:bg-black/5 dark:active:bg-white/5', TEXT.muted)}
        aria-label="Menu"
      >
