  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="space-y-2.5">
          {PAYMENT_METHODS.map((pm) => (
            <div
              key={pm.key}
              className={cn('flex items-center gap-3.5 rounded-lg p-4', SURFACE.card, SURFACE.shadow)}
            >
      ...
      <div>
        ...
        {dateOption === 'custom' && (
          <div className={cn('mt-2.5 rounded-lg p-3.5', SURFACE.card, SURFACE.shadow)}>
            <BzDateTimeField
      ...
      <PrimaryPill
        ...
        className={cn(
          'w-full py-[15px] text-[16px]',
          createRates.isSuccess && 'bg-[#2C2C2C] text-white dark:bg-[#2C2C2C] dark:text-white',
        )}
      >
