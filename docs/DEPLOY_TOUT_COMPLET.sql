-- ============================================================================
-- BONZINI — TOUT le système (emails + connexion Google + inscription + admin)
-- UN SEUL fichier. Colle-le dans Supabase → SQL Editor → Run.
-- 100% IDEMPOTENT : sûr à lancer même si des parties sont déjà appliquées.
-- (Pré-requis déjà faits chez toi : pg_cron activé + secrets Vault.)
-- ============================================================================

-- ═══════════════════ [1/14] 20260531110000_oauth_handle_new_user.sql ═══════════════════
-- ============================================================
-- Chantier A — Lot A2
...
-- ═══════════════════ [2/14] 20260531121000_email_outbox_schema.sql ═══════════════════
-- ============================================================
-- Chantier B — Lot B1
...
-- ═══════════════════ [3/14] 20260531131000_email_enqueue_trigger.sql ═══════════════════
-- ============================================================
-- Chantier B — Lot B2
...
-- ═══════════════════ [4/14] 20260531141000_email_outbox_rpcs.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [5/14] 20260531150000_welcome_email_rpc.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [6/14] 20260531160000_security_clients_update_guard.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [7/14] 20260531170000_email_drainer_cron.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [8/14] 20260601121000_email_support_message_trigger.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [+ ASSISTANT] 20260601140000_assistant_query_open.sql — requête SQL LIBRE (active query_database) ═══════════════════
-- Assistant DO IA — requête SQL LIBRE en lecture (version ouverte, définitive).
-- Remplace les versions précédentes (120000/130000). SEULE migration à exécuter
-- pour query_database. Garde-fou : mode TRANSACTION READ ONLY (toute écriture
-- échoue), admins uniquement, SELECT/WITH seulement, une requête, fonctions
-- système d'accès fichier/réseau/DoS bloquées, timeout 8s, max 1000 lignes.
...
-- ═══════════════════ [9/14] 20260601141000_email_soft_transactional.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [10/14] 20260601160000_email_reminders_cron.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [11/14] 20260601170000_welcome_email_on_client_create.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [12/14] 20260601180000_defer_client_until_verified.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [13/14] 20260601190000_delete_client_frees_email.sql ═══════════════════
-- ============================================================
...
-- ═══════════════════ [14/14] 20260601200000_robust_onboarding_rpc.sql ═══════════════════
-- ============================================================
