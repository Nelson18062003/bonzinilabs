...
| 6 | **Implémentation** (après GO explicite), par lots | [`06-implementation.md`](./06-implementation.md) | 🔄 **En cours** — Lot 0 ✅ + Lot 1A (13 RPC `@mola`) ✅ écrits & vérifiés (type-check+build+118 tests) ; **migrations non déployées** ; Lot 1B (formulaires) bloqué sur déploiement+gen-types |
