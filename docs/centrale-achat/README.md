...
| 6 | **Implémentation** (après GO explicite), par lots | [`06-implementation.md`](./06-implementation.md) | 🔄 **En cours** — Lot 0 livré & vérifié (type-check+build), **migrations non déployées** ; Lot 1 à venir |
