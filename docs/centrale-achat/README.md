...
| 3 | **Couche IA (le cœur)** : extension de Mola (pas un fork), **ingestion-first** (vision réactivée, `proc_ingest_document`, dump mai 2026), capacités `@mola`, RAG métier, self-correction, canal père, reporting PDF, anti-bugs Mola, coûts | [`03-couche-ia.md`](./03-couche-ia.md) | ⏳ **Rendu — en attente de validation** (5 questions ouvertes) |
