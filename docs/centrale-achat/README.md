...
| 6 | **Implémentation** (après GO explicite), par lots | [`06-implementation.md`](./06-implementation.md) | 🔄 **En cours** — Lot 0 ✅ + Lot 1A (13 RPC écriture) ✅ + Lot 2/3 (4 RPC lecture/rapport) ✅ écrits & vérifiés ; **6 migrations non déployées** ; UI (formulaires/écrans) + PDF bloqués sur déploiement+gen-types |
