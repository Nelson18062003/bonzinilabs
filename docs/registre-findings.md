...
| F-030 | Portefeuille | données tronquées | P2 | `useClientManagement.ts:224` : grand livre client `.limit(1000)` sans pagination → au-delà, les écritures anciennes sont invisibles sans message | HAUT | ouvert | à paginer (`useInfiniteQuery` + déclencheur) — itération ultérieure |
