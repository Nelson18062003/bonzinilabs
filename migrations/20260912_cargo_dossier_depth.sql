...
--
-- De quoi remplir le dossier complet : jalons camerounais après l'arrivée,
-- références douane/BESC, description de la marchandise, et la table des
-- coûts réels du dossier.
-- Source : supabase/migrations/20260912140000_cargo_dossier_depth.sql
-- Idempotente. À exécuter dans le projet Bonzini (fmhsohrgbznqmcvqktjw),
-- SQL Editor → Run. Prérequis : les migrations Cargo du 11 et du 12/09.
-- ============================================================================
-- ============================================================
