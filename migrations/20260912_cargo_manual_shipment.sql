-- ============================================================================
-- Bonzini Cargo — migration à appliquer (Supabase / PostgreSQL) — 2026-09-12
--
-- UNE SEULE fonction : create_cargo_shipment_manual (ajouter un conteneur à
-- la flotte sans suivi armateur — en attendant l'API CMA CGM).
-- Source : supabase/migrations/20260912090000_cargo_manual_shipment.sql
-- Idempotente (CREATE OR REPLACE). À exécuter dans le projet Bonzini
-- (fmhsohrgbznqmcvqktjw), SQL Editor → Run.
-- Prérequis : la migration consolidée du 2026-09-11 (module Cargo) est appliquée.
-- ============================================================================
-- ============================================================
