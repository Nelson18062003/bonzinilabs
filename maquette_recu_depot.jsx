  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0edf3", padding: "24px 16px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 900, color: B.violetDark, marginTop: 4 }}>Reçu de dépôt</div>
      </div>

      <ReceiptLayout type="depot" reference="BZ-DP-2026-0017">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          <StatusBadge status="Validé" color={B.green} bg={B.greenLight} />
          <span style={{ fontSize: 11, color: B.muted }}>07 mars 2026 à 08:56</span>
        </div>

        <AmountBlock amount={1029000} />

        <SectionTitle>Transaction</SectionTitle>
        <InfoRow label="Mode de dépôt" value="Cash agence Bonzini" />
        <InfoRow label="Agence" value="Douala — Bonamoussadi" />
        <InfoRow label="Date de création" value="07 mars 2026 à 08:55" />
        <InfoRow label="Date de validation" value="07 mars 2026 à 08:56" />

        <SectionTitle>Client</SectionTitle>
        <InfoRow label="Nom" value="Liliane Kenfack" bold />
        <InfoRow label="Téléphone" value="+237 676 337 404" />
      </ReceiptLayout>
    </div>
  );
}
