  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f0edf3", padding: "24px 16px", fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 900, color: B.violetDark, marginTop: 4 }}>Reçu de paiement — Cash (avec signature)</div>
      </div>

      <ReceiptLayout type="paiement" reference="BZ-PY-2026-0014">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
          <StatusBadge status="Effectué" color={B.violet} bg={B.violetLight} />
          <span style={{ fontSize: 11, color: B.muted }}>06 mars 2026 à 15:46</span>
        </div>

        <AmountBlock amount={8300000} details={[
          { label: "Montant envoyé", value: "¥95 035" },
          { label: "Taux appliqué", value: "11 494" + " XAF/M" },
        ]} />

        <SectionTitle>Transaction</SectionTitle>
        <InfoRow label="Mode de paiement" value="Cash" color={B.orange} bold />
        <InfoRow label="Date de création" value="06 mars 2026 à 15:43" />
        <InfoRow label="Date de traitement" value="06 mars 2026 à 15:46" />

        <SectionTitle>Client</SectionTitle>
        <InfoRow label="Nom" value="Client" bold />

        <SectionTitle>Bénéficiaire</SectionTitle>
        <InfoRow label="Nom" value="Billy Tankeu" bold />
        <InfoRow label="Téléphone" value="+86 166 200 856 25" />
        ...
        <div style={{
          ...
          <div style={{ fontSize: 9, fontWeight: 700, color: B.gold, textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 4 }}>Signature du bénéficiaire</div>
          <div style={{ fontSize: 10, color: B.muted, marginBottom: 12 }}>
            Confirme la réception du paiement en espèces
          </div>
          <div style={{
            width: "100%", height: 100, background: "#fff",
            borderRadius: 8, border: "1px dashed " + B.border,
            display: "flex", alignItems: "center", justifyContent: "center",
          }}>
            <div style={{ fontFamily: "cursive", fontSize: 28, color: B.text, opacity: 0.6, fontStyle: "italic" }}>
              Billy Tankeu
            </div>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
            <div>
              <span style={{ fontSize: 9, color: B.muted }}>Signé par </span>
              <span style={{ fontSize: 10, fontWeight: 700, color: B.text }}>Billy Tankeu</span>
            </div>
            <span style={{ fontSize: 10, color: B.muted }}>06 mars 2026 à 15:46</span>
          </div>
        </div>
      </ReceiptLayout>
    </div>
